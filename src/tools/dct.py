# Discrete Cosine Transform (DCT) and Inverse Discrete Cosine Transform (IDCT) in PyTorch
# Code adapted from https://github.com/zh217/torch-dct/blob/master/torch_dct/_dct.py
...
def mask_image(tensor, tau):
    ...
    mask = (y >= -x + 2*tau*tensor.shape[-1]).float()
    return tensor * mask
