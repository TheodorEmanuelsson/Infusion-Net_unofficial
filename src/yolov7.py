...
class YOLOv7(nn.Module):
    def __init__(self, num_classes:int, cfg_path:str):
        super().__init__()
        ...
        self.backbone = EELAN(self.cfg['backbone']['depths'], self.cfg['backbone']['channels'], self.cfg['backbone']['outputs'], self.cfg['backbone']['norm'], self.cfg['backbone']['act'])
